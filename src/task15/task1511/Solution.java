...
public class Solution {
    public static void main(String[] args) {
        JuniorJavaDev me = new JuniorJavaDev(); //(1)
        System.out.println(me.askHubert("What do you think about com.javarush.task.task15.task1511?")); //(2)
    ...
    public static class JavaDev implements SpecificSerializable {
        String answerQuestion(String question) { //(2.2)
    ...
    public static class JuniorJavaDev  {
        ...
        JavaDev hubert = new JavaDev();//(2.1)

        String askZapp(String question) {
            return zapp.answerQuestion(question);
        }

        String askHubert(String question) { //(2.1)
