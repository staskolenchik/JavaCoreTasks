...
public class Solution {
    public static void main(String[] args) {
        List<Number> list = new LinkedList<Number>(); //(1)
        //3 добавление и удаление элементов коллекции
        initList(list);

        //4 - Исправь 2 ошибки  // вывод каждого элемента коллекции
        printListValues(list);

        //5 //сравнение типа объекта коллекции с Double и Float типами
