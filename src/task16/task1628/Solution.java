...
public class Solution {
    public static volatile AtomicInteger readStringCount = new AtomicInteger(0); //(1) инициализация переменной readStringCount значением 0
    public static volatile BufferedReader reader = new BufferedReader(new InputStreamReader(System.in)); // (2) создание объекта считывания данных
